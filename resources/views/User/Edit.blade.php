            ...
            <div class="card-body">
                   <div class="col-md-12">
                    <div class="m-0 mb-3">
                        ...
                        <input type="text" class="form-control p-2 pb-3 @error('name') is-invalid @enderror" name="name" required value="{{ old('name', $user->name)}}"/>
                        @error('name')
                    ...
                    <div class="m-0 mb-3">
                        ...
                        <input type="text" class="form-control p-2 pb-3 @error('email') is-invalid @enderror" name="email" required value="{{ old('email', $user->email)}}"/>
                        @error('email')
                        <div class="invalid-feedback">
                            {{ $message}}
                        </div>
                    ...
                    @enderror
                        ...
                        <select class="form-control p-3" name="roles_id" required id="roles">
                            ...
                            @foreach ($role as $key )
                            <option class="fw-bold" value="{{ $key->id}}">{{$key->nama}}</option>
                            @endforeach
                          </select>
                     </div>

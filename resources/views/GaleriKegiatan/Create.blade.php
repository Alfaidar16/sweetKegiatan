            ...
            <div class="card-body">
                   ...
                   <div class="col-md-12">
                    <div class="m-0 mb-3">
                        ...
                        <input type="text" class="form-control p-2 pb-3 @error('nama_kegiatan') is-invalid @enderror" name="nama_kegiatan" required value="{{ old('nama_kegiatan')}}"/>
                        @error('nama_kegiatan')
                    ...
                    <div class="m-0 mb-3">
                        ...
                        <input type="text" class="form-control p-2 pb-3 @error('dasar_pelaksanaan') is-invalid @enderror" name="dasar_pelaksanaan" required value="{{ old('dasar_pelaksanaan')}}"/>
                        ...
                        <div class="col-md-4">
                            <div class="m-0 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text"  class="form-control @error('created_at') is-invalid @enderror" name="tanggal" id="tanggal" />
                           ...
                           <div class="col-md-8">
                            <div class="m-0 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control @error('lokasi_kegiatan') is-invalid @enderror" name="lokasi_kegiatan" value="{{ old('lokasi_kegiatan')}}" />
                                </div>
                    ...
                    @enderror
                     ...
                     <div class="mb-3">
                        ...
                        <input id="x"  type="hidden" name="narasi_kegiatan" class="@error('narasi_kegiatan') is-invalid  @enderror" required value="{{ old('narasi_kegiatan')}}">
